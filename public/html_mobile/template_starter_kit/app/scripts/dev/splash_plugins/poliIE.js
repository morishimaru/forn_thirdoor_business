 ...
 */
  ...
  // Store setTimeout reference so promise-polyfill will be unaffected by other
  // code modifying setTimeout (like sinon.useFakeTimers())
 ...
 */
  ...
  function resolve(self, newValue) {
    try {
      ...
      // https://github.com/promises-aplus/promises-spec#the-promise-resolution-procedu
      // re
      if (newValue === self)
 ...
 */
  ...
  var globalNS = (function () {
    // the only reliable means to get the global object is `Function('return
    // this')()` However, this causes CSP violations in Chrome apps.
