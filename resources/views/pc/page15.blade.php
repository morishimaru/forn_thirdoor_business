...
@section('content')
    <div class="home">
        ...
        <div class="right-column">
            ...
            <div class="content">
                ...
                <div class="post-categories">
                    <div class="post-cat-item">
                        <div class="post-cat-item-label post-cat-item-label-1">進行中</div>
                    ...
                    <div class="post-cat-item">
                        <div class="post-cat-item-label post-cat-item-label-2">進行中</div>
                    ...
                    <div class="post-cat-item">
                        <div class="post-cat-item-label post-cat-item-label-3">進行中</div>
                        <div class="post-cat-item-body">
                            <img src="{{ asset('img/box/box3.png') }}" class="post-cat-item-image" alt="3rdoor" />
                            <div class="post-cat-item-title">神泉駅5分 アフタヌーン…</div>
                            <span class="post-cat-item-date">2023/02/01 - 2023/03/01</span>
                    ...
                    <div class="post-cat-item">
                        <div class="post-cat-item-label post-cat-item-label-4">進行中</div>
                        <div class="post-cat-item-body">
                            <img src="{{ asset('img/box/box3.png') }}" class="post-cat-item-image" alt="3rdoor" />
                            <div class="post-cat-item-title">神泉駅5分 アフタヌーン…</div>
                            <span class="post-cat-item-date">2023/02/01 - 2023/03/01</span>
                    ...
                    <div class="post-cat-item">
                        <div class="post-cat-item-label post-cat-item-label-5">進行中</div>
                        <div class="post-cat-item-body">
                            <img src="{{ asset('img/box/box3.png') }}" class="post-cat-item-image" alt="3rdoor" />
                            <div class="post-cat-item-title">神泉駅5分 アフタヌーン…</div>
                            <span class="post-cat-item-date">2023/02/01 - 2023/03/01</span>
                    ...
                    <div class="row">
                        ...
                        <div class="social social-instagram">
                            ...
                            <div class="table-information">
                                <button type="button" class="btn btn-p">投稿を見る</button>
                                <button type="button" class="btn btn-s">承認する</button>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="social social-youtube">
                            ...
                            <div class="table-information">
                                ...
                                <div class="text-1">承認しました</div>
                                <div class="text-2">取り消す</div>
                            </div>
                        </div>
                ...
                <div class="post-footer">
                    <div class="row">
                        <div class="col-1 post-left" ></div>
                        <div class="col-5 post-center">
                            早速の投稿、ありがとうございます！ インスタの投稿ですが、1枚目と2枚目が同じ感じの投稿なので、どちらかを変えて頂く事は可能でしょうか？
                        </div>
                        <div class="col-6 post-right"><a class="post-right-link">メッセージを削除する</a><span class="post-right-date">2023年03月01日 13:15</span> </div>
                    </div>
                </div>
            ...
            <div class="post-searchbars">
                <div class="row">
                    <div class="col-6 post-searchbars-left">
                        <input type="text" class="form-control" >
                        <button type="button" class="btn btn-primary"><i class="fa-solid fa-paper-plane"></i></button>
                    </div>
                    <div class="col-4 post-searchbars-center">
                        <button type="button" class="btn btn-primary">ファイル選択</button>
                        <input type="text" class="form-control" placeholder="選択されていません / 上限 100 MB" >
                    </div>
                    <div class="col-2 post-searchbars-right">
                        <button type="button" class="btn btn-primary">キャンペーンを見る</button>
                    </div>
                </div>
            </div>
        </div>
