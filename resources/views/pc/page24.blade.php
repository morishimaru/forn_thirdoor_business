        ...
        <div class="right-column">
            <div class="searchbars">
                ...
                <div class="datepickers">
                    <div class="d-flex align-items-center">
                        <input type="text" id="from" name="from" value="2023/03/01"/>
                        <span>~</span>
                        <input type="text" id="to" name="to" value="2023/03/28"/>
                    </div>
            ...
            <div class="content">
                ...
                <div class="campaign-summary">
                    ...
                    <div class="datas">
                        <div class="data">
                            <div class="title">平均クリック数</div>
                            <div class="total">4,987,443</div>
                            <div class="desc">過去 28 投稿の データを参照</div>
                        </div>
                        <div class="data data-active">
                            <div class="title">平均投稿数</div>
                            <div class="total">1,692,551</div>
                            <div class="desc">過去 28 投稿の データを参照</div>
                        </div>
                        <div class="data">
                            <div class="title">平均リーチ数</div>
                            <div class="total">1,241,359</div>
                            <div class="desc">過去 25 投稿の データを参照</div>
                        </div>
                        <div class="data">
                            <div class="title">平均インプレッション数</div>
                            <div class="total">201,348</div>
                            <div class="desc">過去 25 投稿の データを参照</div>
                        </div>
                    </div>
                </div>
                <div class="campaign-chart">
                    <div class="title">3/1~3/28の合計</div>
                    <div class="total">1697</div>
