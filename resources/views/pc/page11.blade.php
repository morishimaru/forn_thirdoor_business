...
@section('content')
        ...
        <div class="right-column">
            <div class="searchbars">
                <div class="d-flex align-items-center">
                    ...
                    <div class="title">インフルエンサーを探す</div>
                </div>
                <div class="d-flex align-items-center">
                    <div class="search">
                    ...
                    <div class="filters">
                        <div class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><path fill="#000000" fill-rule="evenodd" d="M20 5h-1.17a3.001 3.001 0 0 0-5.66 0H4a1 1 0 0 0 0 2h9.17a3.001 3.001 0 0 0 5.66 0H20a1 1 0 1 0 0-2zm-4 2a1 1 0 1 0 0-2 1 1 0 0 0 0 2zM3 12a1 1 0 0 1 1-1h1.17a3.001 3.001 0 0 1 5.66 0H20a1 1 0 1 1 0 2h-9.17a3.001 3.001 0 0 1-5.66 0H4a1 1 0 0 1-1-1zm5 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm-4 4a1 1 0 1 0 0 2h9.17a3.001 3.001 0 0 0 5.66 0H20a1 1 0 1 0 0-2h-1.17a3.001 3.001 0 0 0-5.66 0H4zm13 1a1 1 0 1 1-2 0 1 1 0 0 1 2 0z" clip-rule="evenodd" class="color000 svgShape"></path></svg>
                        </div>
                        <div class="title">残りスカウト可能数</div>
                        <div class="total">2</div>
                        <a href="#" class="btn btn-danger">スカウトチケットを購入する</a>
                    </div>
                    <div class="menu">
                        <div class="item item-active">インフルエンサーを探す</div>
                        <div class="item">スカウト中のインフルエンサー</div>
                    </div>
                </div>
            </div>
            <div class="content">
                <div class="post-content">
                    ...
                    <div class="body">
                        ...
                        <div class="text">
                            <div class="time time-top"><span>性別：女性</span>最終ログイン：1 時間前</div>
                            <div class="tags">
    ...
    <div class="filters-popup">
        <div class="column1">
            ...
            <div class="checkboxs checkboxs-min">
                <div class="item">
                    <input type="checkbox" />ゲーム
                </div>
                <div class="item">
                    <input type="checkbox" />グルメ
                </div>
                <div class="item">
                    <input type="checkbox" />トラベル
                </div>
                <div class="item">
                    <input type="checkbox" />レジャー
                </div>
                <div class="item">
                    <input type="checkbox" />アパレル
                </div>
                <div class="item">
            ...
            <div class="title">
                <div class="text">年齢</div>
                <div class="line"></div>
            </div>
            <div class="checkboxs flex-nowrap">
                <div class="item">
                ...
                <div class="item">
                    <input type="checkbox" />40代
                </div>
                <div class="item">
                    <input type="checkbox" />50代
                </div>
                <div class="item">
                    <input type="checkbox" />60代以上
                </div>
            </div>
        </div>
        <div class="column2">
            <div class="title">
                <div class="text">登録者数</div>
                <div class="line"></div>
            </div>
            <div class="slider">
                <img src="{{ asset('img/slider.png') }}" alt="3rdoor" />
                <div class="slider-range"></div>
            </div>
            <div class="control">
                <input type="text" class="form-control" value="0" />
                <span>から</span>
                <input type="text" class="form-control" value="9,999,999" />
            </div>
            <div class="title">
                <div class="text">フォロワー数</div>
                <div class="line"></div>
            </div>
            <div class="slider">
                <img src="{{ asset('img/slider.png') }}" alt="3rdoor" />
        ...
        <div class="column2">
            <div class="title">
                <div class="text">登録男女比</div>
                <div class="line"></div>
            </div>
            <div class="slider">
                <img src="{{ asset('img/slider2.png') }}" alt="3rdoor" />
                <div class="slider-range"></div>
            </div>
            <div class="control">
                <span>男性</span>
                <input type="text" class="form-control form-small" value="4" />
                <span>女性</span>
                <input type="text" class="form-control form-small" value="6" />
            </div>
            <div class="title">
                <div class="text">登録年齢比</div>
                <div class="line"></div>
            </div>
            <div class="slider">
                <img src="{{ asset('img/slider.png') }}" alt="3rdoor" />
        ...
        <div class="column3">
            <div>
                <div class="text">絞り込み結果</div>
                <div class="total">6,372</div>
                <a href="#" class="btn btn-dark">絞り込み結果を見る</a>
            </div>
        </div>
    </div>
@endsection
