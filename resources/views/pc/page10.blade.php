        ...
        <div class="right-column">
            <div class="searchbars">
                <div class="d-flex align-items-center">
                    ...
                    <div class="title">完了したインフルエンサー</div>
                </div>
                <div class="menu">
                    <div class="item">応募者一覧</div>
                    <div class="item">応募者一覧<span>187</span></div>
                    <div class="item">進行中のインフルエンサー<span>1</span></div>
                    <div class="item item-active">投稿完了のインフルエンサー</div>
                </div>
            </div>
            <div class="content">
                <div class="post-summary">
                    <div class="post-summary-left">
                        ...
                        <div class="body">
                            ...
                            <div class="time">募集期間：2023/02/01 - 2023/03/01</div>
                            <div class="tags">
                    ...
                    <div class="post-summary-right">
                        <div class="body">
                            <div class="title">投稿完了数</div>
                            <div class="total">2</div>
                        </div>
                    </div>
                </div>
                <div class="post-filter">
                    <div class="total">全 2 件：</div>
                    <div class="checkbox">
                        <input type="checkbox" />ピン留め中のインフルエンサーのみ表示
                    </div>
                    <div class="d-flex">
                        <select class="form-select"><option>全性別</option></select>
                        <select class="form-select"><option>全年齢</option></select>
                        <select class="form-select flex-shrink-0" style="width: 200px"><option>応募日時が新しい順</option></select>
                    </div>
                </div>
                <div class="post-content">
                    <div class="marks marks-hide">
                        <div class="triangle-wrap"><div class="triangle triangle-green"></div></div>
                        <i class="fa-sharp fa-solid fa-thumbtack fa-rotate-90"></i>
                    </div>
                    <div class="body">
                        <div class="avatar">
                ...
                <div class="post-content">
                    ...
                    <div class="body">
                        <div class="avatar">
                            <img src="{{ asset('img/box/avatar2.png') }}" alt="3rdoor" />
                        </div>
                        <div class="text">
                            <div class="title">ロシナンテのミルク</div>
                            <div class="time"><span>性別：女性</span>最終ログイン：1 時間前</div>
                            <div class="desc">
                                165㎝45㎏　ファッションモデル　いつも笑顔＆ポジティブ！フォロワーさんは大切な支え♡いつも感謝！<br/>
                                興味＆関心→食べるの大好き/イメージモデル/アンバサダー/グルメ/おしゃれ/ゲーム/ペット/かわいい/インリア/ダイエット/美容/北海道<br/>
    ...
    <div class="post-popup">
        ...
        <div class="body">
            ...
            <div class="text">
                ...
                <div class="desc">
                    165㎝45㎏　ファッションモデル　いつも笑顔＆ポジティブ！フォロワーさんは大切な支え♡いつも感謝！<br/>
                    興味＆関心→食べるの大好き/イメージモデル/アンバサダー/グルメ/おしゃれ/ゲーム/ペット<br/>
                    出身→東京在住/モデル以外のお仕事→歌/音楽制作/デザイン/イラスト制作ができます！
                </div>
            </div>
        </div>
        <div class="status">
            ...
            この度は採用ありがとうございました！また機会がございましたら、是非よろしくお願いします。
        </div>
        <div class="social social-tiktok">
            <div class="icon">
                <i class="fa-brands fa-tiktok"></i>
            </div>
            <div class="images no-used">
                NO USED
            </div>
            <div class="table-information">
                <div class="item">
                    <div class="item-left">フォロワー数</div>
                    <div class="item-right">ー</div>
                </div>
                <div class="item">
                    <div class="item-left">投稿日時</div>
                    <div class="item-right">ー</div>
                </div>
                <div class="item">
                    <div class="item-left">投稿先リンク</div>
                    <div class="item-right">ー</div>
                </div>
                <div class="item">
                    <div class="item-left">いいね数</div>
                    <div class="item-right">ー</div>
                </div>
                <div class="item">
                    <div class="item-left">コメント数</div>
                    <div class="item-right">ー</div>
                </div>
            </div>
        </div>
        <div class="social social-instagram">
            ...
            <div class="table-information">
                <div class="item">
                    <div class="item-left">フォロワー数</div>
                    <div class="item-right">163,024</div>
                </div>
                <div class="item">
                    <div class="item-left">投稿日時</div>
                    <div class="item-right">2023/01/23</div>
                </div>
                <div class="item">
                    <div class="item-left">投稿先リンク</div>
                    <div class="item-right text-decoration-underline">投稿を見る</div>
                </div>
                <div class="item">
                    <div class="item-left">いいね数</div>
                    <div class="item-right">61 いいね</div>
                </div>
                <div class="item">
                    <div class="item-left">コメント数</div>
                    <div class="item-right">0 コメント</div>
                </div>
            </div>
        </div>
        <div class="social social-youtube">
            ...
            <div class="images">
                <img src="{{ asset('img/box/gallery2.png') }}" alt="3rdoor" />
            </div>
            <div class="table-information">
                <div class="item">
                    <div class="item-left">チャンネル登録者数</div>
                    <div class="item-right">1,421,005</div>
                </div>
                <div class="item">
                    <div class="item-left">投稿日時</div>
                    <div class="item-right">2023/01/23</div>
                ...
                <div class="item">
                    <div class="item-left">再生数</div>
                    <div class="item-right">32,618 再生</div>
                </div>
            </div>
        </div>
        <div class="social social-twitter">
            ...
            <div class="table-information">
                ...
                <div class="item">
                    <div class="item-left">リツイート数</div>
                    <div class="item-right">25 リツイート</div>
                </div>
            </div>
        </div>
    </div>
